...
* Add the following files to you Visual Studio project:
  ...
  * InnerFence.ChargeDemo.Phone\ChargeAPI\ChargeUriMapper.cs
...
* InnerFence.ChargeDemo.Phone\README.md
...
* InnerFence.ChargeDemo.Phone\App.xaml
* InnerFence.ChargeDemo.Phone\App.xaml.cs
* InnerFence.ChargeDemo.Phone\AssociationUriMapper.cs

Main application that handles the response when activated via your
registered protocol URL scheme.

* InnerFence.ChargeDemo.Phone\MainPage.xaml
* InnerFence.ChargeDemo.Phone\MainPage.xaml.cs
...
* InnerFence.ChargeDemo.Phone\Properties\WMAppManifest.xml

Registers the com-innerfence-chargedemo:// URL scheme.

* InnerFence.ChargeDemo.Phone\Properties\AssemblyInfo.cs
* InnerFence.ChargeDemo.Phone\Properties\AppManifest.xml

These files are all stock as generated by Visual Studio.

* ChargeDemo.sln
* InnerFence.ChargeDemo.Phone\ChargeDemo.Phone.csproj
